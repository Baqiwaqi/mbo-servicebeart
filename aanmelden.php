...
<nav aria-label="breadcrumb" id="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item text-white active" aria-current="page">Aanmelden</li>
    </ol>
</nav>
<!-- /breadcrumbs -->
<!-- aanmeld form -->
<div class="container" id="aanmelden">
    <h2>Aanmelden</h2>
    <p>Om een afspraak te maken voor een reparatie of service beurt moet je eerst een account aanmaken</p>
    <form class="form-horizontal" action="includes/aanmelden.inc.php" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="huisnummer" placeholder="huisnummer" name="huisnummer">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="woonplaats" placeholder="woonplaats" name="woonplaats">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" class="form-control" id="pwdh" placeholder="Herhaling password" name="pwdh">
            </div>
        </div>
        <div class="form-group">
