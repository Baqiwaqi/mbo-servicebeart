...
<div class="container" id="aanmelden">
    <h2>Hier kan je een klanttoevoegen</h2>
    <form class="form-horizontal" action="includes/toevoegen.inc.php" method="post">
...
if (isset($_GET['succes'])) {
    echo "  <script>
                    alert('Je hebt succesvol een gebruiker succesvol aangemaakt!');
                </script>";
}
?>
